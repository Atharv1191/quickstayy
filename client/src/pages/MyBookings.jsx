    ...
    <div className='py-28 md:pb-35 md:pt-32 px-4 lg:px-24 xl:px-32'>
      ...
      <div className='max-w-6xl mt-8 w-full text-gray-800'>
        ...
        {bookings.map((booking) => {
            console.log("Booking room images:", booking.room?.images) 
          const hotel = booking.hotel
          const room = booking.room
          const image = room?.images?.[0] || assets.placeholderImage // fallback if no image
            ...
            >
              ...
              <div className='flex flex-col md:flex-row'>
                ...
                <div className='flex flex-col gap-1.5 max-md:mt-3 min-md:ml-4'>
                  <p className='font-polyfair text-2xl'>
